...
app.controller('dangkyusersCtrl', function ($scope, $http, $location) {
    ...
    $scope.onClickDangky = function () {
        ...
        if ($scope.users.Ho === '') {
            ...
            $scope.formMessage = 'Bạn ơi, nhập Họ đi bạn.';
        ...
        if ($scope.users.Ten === '') {
            $scope.formStatus = false;
            $scope.formMessage = 'Bạn ơi, nhập Tên đi bạn.';
        ...
        if ($scope.users.Email === '') {
            $scope.formStatus = false;
            $scope.formMessage = 'Bạn ơi, nhập Email đi bạn.';
